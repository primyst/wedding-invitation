...
export default function CelebrationExperience() {
  return (
    <>
      <section className="heritage-section relative min-h-[100svh] overflow-hidden text-white">
        ...
        >
          <div className="max-w-3xl text-left sm:text-center">
            <p className="text-[10px] uppercase tracking-[0.52em] text-[#ead2ae] sm:text-xs">Love, roots & celebration</p>
      ...
      <section className="frame-section relative overflow-hidden px-5 py-28 text-[#f5eee4] sm:py-40">
        ...
        <div className="relative z-10 mx-auto grid max-w-6xl gap-16 md:grid-cols-[1.05fr_0.95fr] md:items-center">
          ...
          >
            <p className="text-[10px] uppercase tracking-[0.5em] text-[#cba87a]">One more thing</p>
            <h2 className="frame-title mt-6">The best part is that <em>you&apos;re</em> invited.</h2>
            <div className="mx-auto mt-7 h-px w-16 bg-[#cba87a]/50 md:mx-0" />
            <p className="mx-auto mt-8 max-w-lg text-lg leading-8 text-[#d9cec2] md:mx-0">
            ...
            <motion.p
              ...
              className="mt-10 font-serif text-2xl italic text-[#e4c69f]"
            >
